...
namespace Edgar.Unity
{
    ...
    public class MinimapPostProcess : DungeonGeneratorPostProcessBase 
    {
        ...
        private Tilemap CreateTilemap(string tilemapName, GeneratedLevel level, int sortingOrder, Material material)
        {
        ...
        /// </summary>
        private HashSet<Vector3Int> CopyTilesToLevelMap(GeneratedLevel level, ICollection<string> sourceTilemapNames, Tilemap levelMapTilemap, TileBase levelMapTile, HashSet<Vector3Int> ignoredTiles = null)
        {
            var usedTiles = new HashSet<Vector3Int>();
...
#if UNITY_EDITOR
        [CustomEditor(typeof(MinimapPostProcess), true)]
