...
namespace Edgar.Unity.Examples
{
    ...
    public class WandererInputSetUp : DungeonGeneratorInputBase
    {
        ...
        public WandererRoomTemplateConfig RoomTemplates;
        ...
        protected override LevelDescription GetLevelDescription()
        {
            ...
            if (UseRandomLevelGraph)
            {
                ...
                LevelGraph = levelGraphs.GetRandom(Payload.Random);
            }
           ...
           // The instance of the game manager will not exist in Editor
            ...
            foreach (var room in LevelGraph.Rooms.Cast<WandererRoom>())
            {
