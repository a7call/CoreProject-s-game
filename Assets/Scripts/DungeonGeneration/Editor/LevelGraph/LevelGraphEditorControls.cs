...
public partial class LevelGraphEditor
{
            ...
            case EventType.MouseDown:
                {
                    ...
                    if (CurrentState == State.Idle)
                    {
                        ...
                        if (currentHoverRoomNode != null)
                        {
                            ...
                            {
                                hoverRoomNode = (RoomNode)currentHoverRoomNode;
    ...
    public ConnectionBase CreateConnection(RoomNode from, RoomNode to)
    {
        ...
        // TEST
        to.Room.ConnectedRooms.Add(from.Room);
        from.Room.roomToConnect.Add(to.Room);
        // END TEST
    ...
    private RoomBase CreateRoom(Vector2 position)
    {
        ...
        Debug.Log(room.ConnectedRooms.Count);
    ...
    {
        connectionNode.Connection.To.ConnectedRooms.Remove(connectionNode.Connection.From);
        connectionNode.Connection.From.roomToConnect.Remove(connectionNode.Connection.To);
